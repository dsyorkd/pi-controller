...
- [ ] Before creating RC1, create a new milestone and stable branches for the release [[doc](https://github.com/dsyorkd/pi-controller/wiki/Creating-a-new-milestone)].
- [ ] Release candidate builds [[doc](https://github.com/dsyorkd/pi-controller/wiki/Create-a-Harvester-release)].
...
- [ ] Update the README. (PR: )
  - [ ] Update the release to the latest in the [versions](https://github.com/dsyorkd/pi-controller?tab=readme-ov-file#releases).
  - [ ] Update screenshots.
- Support matrix
...
cc @pi-controller/dev @pi-controller/qa
