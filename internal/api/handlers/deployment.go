...
func (h *DeploymentHandler) handleServiceError(c *gin.Context, err error, message string) { // nolint:dupl // Common error handling pattern duplicated in test helpers
